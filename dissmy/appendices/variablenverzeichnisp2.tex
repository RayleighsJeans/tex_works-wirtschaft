...
\begin{longtable}{|l|l|} %Beginn Tabelle
	...
	\endlastfoot
		...
		$c(t)$ & Konsumgütermenge\\%S.17
		$c(t)_{ex}$ & Exportgütermenge\\%S.31
		$c(t)_{im}$ & Importgütermenge\\%S.31
	  ...
	  $\bar{M}$ & Grenzprodukt des Kapitals einer offenen Volkswirtschaft\\%S.43
		$N(t)$ & Bevölkerungsgrö{\ss}e\\%S.15
		$N_0$ & Startwert der Bevölkerungsgrö{\ss}e\\
		$n$ & Bevölkerungswachstumsrate\\%S.17
		...
		$\alpha$ & Produktionselastizität im Konsumgutsektor des physischen Kapitals\\%S.16
		$\gamma_{1}$ & Schattenpreis des physischen Kapitals\\%S.19
	  %$\gamma_{1im}$ & Schattenpreis des pysischen Kapitals Importgütermenge???\\%S.33
		$\gamma_{2}$ & Schattenpreis des Humankapitals\\%S.19
		$\dot{\gamma}$ & Abschreibungsrate des Schattenpreises\\%S.21
		$\eta$ & Produktionselastizität im Bildungssektor des physischen Kapitals\\%S.16
		$\rho$ & Diskontrate\\%S.17
		$\sigma$ & intertemporale Substitutionselastizität\\%S.17
		$\phi$ & Absorbtionsrate\\%S.31
		$\chi$ & Kapital-Konsumquote\\%S.26
		$\chi_{ex}$ & Kapital-Exportgüterquote\\%S.39
		$\chi_{im}$ & Kapital-Importgüterquote\\%S.39
		$\psi$ & Nutzen \\\hline
