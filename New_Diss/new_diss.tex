...
\usepackage{paralist} 
\usepackage{enumitem}
\usepackage{amssymb,xcolor,amsmath}
\usepackage{tikz}
\usepackage{fancybox}
\usetikzlibrary{arrows,positioning}
\usepackage{acronym}
...
\begin{titlepage}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.3\textwidth]{images/logo.pdf} % University/department logo
	\end{figure}
...
\include{content/Wachstumstheorien}
\include{content/Kapitel3}
\include{content/Konvergenz}
\include{content/Entwicklungsstrategien}
\include{content/Papier1}
...
\include{appendices/mathematischerAnhang1}
\include{appendices/mathematischerAnhang2}
\include{appendices/variablenverzeichnisp2}
\include{appendices/Parameterverzeichnis}
\include{appendices/Variablenverzeichnisp1}
\include{appendices/Parameterverzeichnis2}
