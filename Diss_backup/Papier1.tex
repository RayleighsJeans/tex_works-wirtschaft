%\chapter{Modell-Acemoglu}\label{Papier1}
\chapter{Imitation vs. Innovation - \newline Die Wirkung 
%von Handelspolitik/
einer Exportunterstützung auf den technologischen Entwicklungsstand eines Landes}\label{Papier1}
...
\begin{equation}I=\lambda\gamma A_{t-1}(\nu)\end{equation}\label{Meta}
...
\\
Die Aufgabe der Unternehmen besteht in der Bearbeitung von Projekten.%hier am Beispiel der Produktion von Kleidungsstücken. 
...
\begin{equation}w_j=\frac{1-\alpha_j}{\alpha_j}A_t^{1-\alpha_j}x_{tj}^{\alpha_j}N_j^{-\alpha_j}\end{equation}
	...
	%\hfill	\footnotesize\sffamily\textbf{Quelle:} eigene Darstellung
		%% durch das Flushright schiebt sich das ganze etwas doll nach unten, wenn ich es wegnehe, dann verschiebt sich die ABBildung nach links....
...
\psfrag{WGA}[c]{$X_{L_{2}}$}
 ...
 \psfrag{y}[c]{Anteil Sektor 2}
	\includegraphics[width=0.49\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/neuest5.eps}
...
%\section{Konsum}\label{sec:Konsum}
%Der Einfachhalt halber soll \underline{angenommen} werden, dass die produzierte Menge der nachgefragten Menge entspricht und %konsumiert wird. 
%\\
%Somit sind die Produktqualitäten perfekte Substitute. Der repräsentative Haushalt differenziert nicht nach Produktqualität und hat dahingehend keine Präferenzen. 
%\\
%In diesem Modell sind alle Wirtschaftssubjekte risikoneutral. Der \textcolor[rgb]{1,0.75,0.8}{repräsentative Haushalt/ Kapialisten?} hält in einem ausgeglichenem Ma{\ss}e Firmenanteile von Forschungsunternehmen mit unterschiedlichen Erfolgsaussichten. Diese Aufteilung der Anteile auf die verschieden Unternehmen verhalten sich wie eine Risikoaufteilung der Haushalte. Das Portfolio an Firmenanteilen wird nicht als Vermögen verstanden. Die Ziele der Unternehmungen bleiben unbeeinflusst. Die Unternehmen maximieren ihren erwarteten Gewinn. Dabei legen die Unternehmen den Preis fest, den die Konsumenten als gegeben hinnehmen. {Acemoglu 2009 60C: 429}\\
...
\begin{equation} V_{tj} (\nu|s=1,e=O,z=L)=[(1-\mu)\delta_j N_j \eta\overline{A}_{t-1}-max(\kappa\overline{A}_{t-1}-RE_t,0)]\label{Wert}\end{equation}
...
\end{equation}Gleichung \eqref{erwarteter Wert} ist die formale Darstellung des erwarteten Marktwertes junger Ingenieure und setzt sich wie folgt zusammen: 
...
\begin{equation}
V_{tj}(\nu|s=1,e=o,z=L) > E_t V_{tj} (\nu|s=\sigma_j,e=y)\label{Wertvergleich}\end{equation}
...
\begin{equation}A_{tj}^{y}=\sigma_j(\eta\overline{A}_{t-1}+\lambda\gamma A_{t-1})\label{Produktivitat jung}\end{equation}
...
\begin{equation}A_{tj}^{o}[R_{tj}=1]=\eta\overline{A}_{t-1}+\lambda\gamma A_{t-1}\label{Produktivitat nur alte}\end{equation}
...
\begin{equation}A_{tj}^o[R_{tj}=0]=\lambda(\eta\overline{A}_{t-1}+\gamma A_{t-1})+(1-\lambda)\sigma_j(\eta\overline{A}_{t-1}+\lambda\gamma A_{t-1})\label{Produktivitat alt und jung}
\end{equation}
...
\begin{equation}\frac{A_t}{A_{t-1}}\equiv\frac{\int_0^1A_{t}(\nu)d\nu}{A_{t-1}}=\int_0^1s_{tj}(\nu)\left[\eta\frac{\overline{A}_{t-1}}{A_{t-1}}+\gamma_t(\nu)\right]d\nu
\label{WachstumTechnologie}\end{equation}
...
\begin{equation}a_{tj}=\begin{cases}\frac{1+\sigma_j}{2(1+g)}[\eta+\lambda \gamma a_{t-1j}] \hfill\text{if  } R_{tj}=1 \\
...
(1+\sigma_j)\lambda \gamma a_{t-1j}<(1+\sigma_j+(1-\lambda)\sigma_j)\lambda\gamma a_{t-1j}\footnote{Dies gilt ausgehend von dem Gleichen technologischen Entwicklungsstand $a_{t-1j}$.} \end{equation}
...
\vspace{0.13cm}
 ...
 \begin{overpic}[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/einSektorExo.eps}
...
\begin{equation}\tilde{a}_{R=1}=\frac{(1+\sigma_j)\eta}{2(1+g)-\lambda\gamma(1+\sigma_j)}\label{eq:aTilde1}\end{equation}
\begin{equation}\tilde{a}_{R=0} = \frac{(\lambda+\sigma+(1-\lambda)\sigma)\eta}{2(1+g)-(1+\sigma+(1-\lambda)\sigma)\lambda\gamma}\label{eq:aTilde0}\end{equation}
...
In technologisch gro{\ss}en Ländern handelt es sich um eine endogene WTG, dann verändert jede Innovation die WTG. Diese Situation ist in Abbildung \ref{fig:ein Sektor endogene WTG} dargestellt.%ABBILDUNG 
\begin{figure}[htb]
\vspace{0.13cm} 
 \centering 
 \psfrag{a}{$a$}
 ...
 \begin{overpic}[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/einSektorEndo.eps}
...
\begin{equation}\left(\frac{p_1}{p_2}\right)^{H}>\left(\frac{p_1}{p_2}\right)^{WM}, \text{wenn} \quad A^{WM}>A^{H}\end{equation}
...
\begin{equation}a_{tj}=\begin{cases}\frac{1+\sigma_j}{2(1+g_j(\sigma_j))}[\eta+\lambda \gamma a_{t-1}] \hfill\text{if  } R_{tj}=1 \\
...
\vspace{0.13cm}
	...
	\psfrag{1.0}[c]{\scriptsize{1}}
\begin{overpic}
[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/ImExogeneWTG.eps}
...
\end{figure*}
%Gro{\ss}e Projekte mit $\sigma=0.75$
...
\vspace{0.13cm}
	...
	\psfrag{1.0}[c]{\scriptsize{1}}
\begin{overpic}
[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/ExExogeneWTG.eps}
...
\vspace{0.13cm}
	...
	\psfrag{a}{$a_r$}
		...
		\psfrag{1.0}[c]{\scriptsize{1}}
		\psfrag{$\sigma$}[c]{}
		 \begin{overpic}[width=0.5\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/Ar.eps}
...
\vspace{0.43cm}
  \subfigure[Imitationsstrategie]{
	 \centering
		...
		\psfrag{1.0}[c]{\scriptsize{1}}
		\includegraphics[width=0.47\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/ATildeR1Ex.eps}}
    \subfigure[Innovationsstrategie]{
		...
		\psfrag{0.8}[c]{\scriptsize{0.8}}
		\psfrag{1.0}[c]{\scriptsize{1}}
		\includegraphics[width=0.47\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/ATildeR0Ex.eps}}\\
		\hfill\footnotesize\sffamily{\textbf{Quelle:}}  eigene Darstellung
...
\vspace{0.13cm}
	\centering
		...
		\psfrag{0.8}[c]{\scriptsize{0.8}}
		\psfrag{1.0}[c]{\scriptsize{1}}
		\includegraphics[width=0.7\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/beideATildeInEinerAbbEx.eps}\\
		\hfill\footnotesize\sffamily{\textbf{Quelle:}}  eigene Darstellung
...
\vspace{0.13cm}
 ...
 \psfrag{a}{$a$}
	...
	\psfrag{1.0}[c]{\scriptsize{1}}
\begin{overpic}
[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/ImEndogeneWTG.eps}
...
\vspace{0.13cm}
 ...
 \psfrag{a}{$a$}
	...
	\psfrag{1.0}[c]{\scriptsize{1}}
\begin{overpic}
[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/ExEndogeneWTG.eps}
 ...
 %\put(0.1,57.5){\textcolor{black}{\scriptsize{1}}}
\end{overpic}\\
\hfill\footnotesize\sffamily{\textbf{Quelle:}}  eigene Darstellung
...
\vspace{0.13cm}
 ...
 \psfrag{a}{$a$}
		...
		\psfrag{0.8}[c]{\scriptsize{0.8}}
		\psfrag{1.0}[c]{\scriptsize{1}}
 \begin{overpic}	[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/beideSektorenExoWTG.eps}
...
\vspace{0.13cm}
 ...
 \psfrag{a}{$a$}
		...
		\psfrag{0.8}[c]{\scriptsize{0.8}}
		\psfrag{1.0}[c]{\scriptsize{1}}
 \begin{overpic}[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/beide.eps}
%\put(25.5,0.67){\textcolor{black}{$\hat{a}_t$}}
\put(58.2,0.9){\textcolor{black}{$a_{rIm}$}}
%\put(-3,34.5){\textcolor{black}{\scriptsize{0.6}}}
\end{overpic}\\
\hfill\footnotesize\sffamily{\textbf{Quelle:}}  eigene Darstellung
...
\vspace{0.13cm}
 ...
 \psfrag{a}{$a$}
		...
		\psfrag{0.8}[c]{\scriptsize{0.8}}
		\psfrag{1.0}[c]{\scriptsize{1}}
 \begin{overpic}[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/Lambdaaexo.eps}
...
\vspace{0.13cm}
	...
	\psfrag{a}{$a_r$}
		...
		\psfrag{L}[c]{$\lambda$}
		 \begin{overpic}[width=0.5\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/aRLambda.eps}
	%\put(98,16){\textcolor{black}{$\sigma$}}
	%\put(0.5,23){\textcolor{black}{\scriptsize{0.2}}}
	%\put(0.5,30){\textcolor{black}{\scriptsize{0.4}}}
  %\put(0.5,38){\textcolor{black}{\scriptsize{0.6}}}
...
\vspace{0.13cm}
 ...
 \psfrag{a}{$a$}
		...
		\psfrag{0.8}[c]{\scriptsize{}}
		\psfrag{1.0}[c]{\scriptsize{1}}
 \begin{overpic}[width=0.9\textwidth]{C:/Users/BibiKiBa/Diss/Doktorarbeit/ModellEins/Abbildungen/Lambdaaendo.eps}
